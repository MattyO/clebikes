...
STATIC_ROOT = '/srv/clebikes/static/'
...
SECRET_KEY = '+k__2f=^sf8+5jpmse1t20)jp6)$=k*_e@&rh6g3r*=^+l4u1q'
...
ROOT_URLCONF = 'clebikes.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'clebikes.wsgi.application'
